...
#In funciton intelligent -> Add check condition if value = 1-60 then don't execute instruction

#In function intelligent -> if value>0 then reduce value by 1 ,elif value<0 then increase by 1
